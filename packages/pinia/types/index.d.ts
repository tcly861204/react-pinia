...
declare const createStore: <T extends { [K in keyof T]: T[K] }>(options: {
  [K_1 in keyof T]: StateOption<T[K_1]>
}) => {
  [key: string]: {
    (): State<unknown>
    get(): State<unknown>
...
declare const useStore: <T extends { [K in keyof T]: T[K] }, K_1 extends keyof T>(
  globalKey: K_1
) => (State<T[K_1]> & Getters<T[K_1]> & Actions<T[K_1]>) | null

declare const version = '2.7.1'
